...
var Layout = function() {
    ...
    var handleTheme = function() {
        ...
        var setColor = function(color) {
            ...
            if (color == 'light2') {
                $('.page-logo img').attr('src', layoutImgPath + 'logo_icon_openslides.png');
            } else {
                $('.page-logo img').attr('src', layoutImgPath + 'openslides_logo.png');
            }
            if ($.cookie) {
    ...
    // handle notifications
        ...
        $.ajax({
            ...
            data: {action: "readNotifications"},
            success: function() {
//                console.log('success');
                $("li.dropdown-notification .badge-default").text('0');
            }
        });
    });
    //* END:CORE HANDLERS *//
