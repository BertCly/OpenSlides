 ...
 * jQuery Live Menu
 * 
 * Created by Loopus : http://codecanyon.net/user/loopus
 * Using this plugin requires a license : http://codecanyon.net/item/jquery-live-menu/2277197
 */
(function($) {
    function liveMenu (element, options) {      
        var defaults = {  
            button: 'left',
            imagesPath: 'icons/',
            items:[],
    ...
    liveMenu.prototype.update = function(){
        ...
        $element.bind('mousedown.liveMenu',function(e)
        {
            ...
            {                    
                if ($element.find('.liveMenu').length == 0) {
                    plugin.showMenu();
                
                }
            } 
            else if ((e.button == 1) && (plugin.settings.button == 'left'))
            {                    
                plugin.showMenu();
            } 
            else if (e.button == 2)
    ...
    liveMenu.prototype.showMenu = function(){
        ...
        var show = function (){
            ...
            else if (_this.settings.layout == 'circle')
            {
                $menu.addClass('layoutCircle');
                $menu.attr('id', 'liveMenuCircle');
            }
        ...
        var applyTooltipGradient = function(){
            ...
            $tooltipContent.css('background',webkitCss);
            $tooltipContent.css('background','-moz-linear-gradient(top,' + defCss + ')');
            $tooltipContent.css('background','-webkit-linear-gradient(top,' + defCss + ')');
            $tooltipContent.css('background','-o-linear-gradient(top,' + defCss + ')');
            $tooltipContent.css('background','-ms-linear-gradient(top,' + defCss + ')');
            $tooltipContent.css('background','linear-gradient(top,' + defCss + ')');
            $tooltipContent.css({
                '-moz-border-radius': _this.settings.tooltip.radius+'px',
                '-webkit-border-radius': _this.settings.tooltip.radius+'px',
                'border-radius': _this.settings.tooltip.radius+'px'
            });
