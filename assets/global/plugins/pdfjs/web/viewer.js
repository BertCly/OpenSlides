...
var DEFAULT_URL = '';//'../userData/courses/metenmetlat.pdf';
var DEFAULT_SCALE = 'page-fit';
var DEFAULT_SCALE_DELTA ='page-fit';
var UNKNOWN_SCALE = 0;
var CACHE_SIZE = 20;
...
PDFJS.imageResourcesPath = '../assets/global/plugins/pdfjs/web/images/';
  PDFJS.workerSrc = '../assets/global/plugins/pdfjs/build/pdf.worker.js';
  PDFJS.cMapUrl = '../assets/global/plugins/pdfjs/web/cmaps/';
...
var PageView = function pageView(container, id, scale,
  ...
  this.draw = function pageviewDraw(callback) {
    ...
    function pageViewDrawCallback(error) {
      ...
      var event = document.createEvent('CustomEvent');
      event.initCustomEvent('openDocument', true, true, {
