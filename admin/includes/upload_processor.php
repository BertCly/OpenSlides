...
$uploadsDirectory = $_SERVER['DOCUMENT_ROOT'] . $directory_self . '../../userData/profile/';

// make a note of the location of the upload form in case we need it 
$uploadForm = 'http://' . $_SERVER['HTTP_HOST'] . $directory_self . '../profile.php';

// make a note of the location of the success page 
$uploadSuccess = 'http://' . $_SERVER['HTTP_HOST'] . $directory_self . '../profile.php#tab_1_3';
...
$db->logEvent('ProfileEdited', 'Avatar ' . $_SESSION['user_id'] . ' edited');

$db->update(
    'tblUserMeta',
    array(
        'MetaValue' => $now.'-'.$_FILES[$fieldname]['name']
    ),
