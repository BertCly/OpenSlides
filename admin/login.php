...
Version: 1.0
Author: Bert Clybouw
LinkedIn: https://www.linkedin.com/pub/bert-clybouw/65/6b2/a54/
Contact: bert.clybouw@student.kuleuven.be
Follow: www.twitter.com/BertClybouw
License: All copyright owned by Bert Clybouw
-->
...
<html lang="en" class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Presentation | De digitale pennenzak</title>
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <meta content="width=device-width, initial-scale=1" name="viewport"/>
        <meta content="" name="description"/>
        <meta content="Libaro, team Presentation" name="author"/>
        ...
        <!--    Hierboven wordt normaal header.php gebruikt. deze is een uitzondering omdat geen check op ingelogd-->
    ...
    <body class="login">
        ...
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <form id="loginForm" class="login-form" action="../assets/global/dataConnection/process_login.php" method="post">
                <h3 class="form-title">Login to your account</h3>
                <div class="alert alert-danger display-hide">
                    <button class="close" data-close="alert"></button>
                    <span>
                        Fill in your username and password </span>
                </div>
                ...
                <div class="create-account">
                    <p>
                        Don't have an account yet ? &nbsp; <a href="javascript:;" id="register-btn" class="btn blue pull-right">
                            Sign up</a>
                    </p>
                </div>
            </form>
            ...
            <form id="registerForm" class="register-form" action="../assets/global/dataConnection/register.inc.php" method="post">
                <h3>Sign Up</h3>
                <p>
                ...
                <div class="form-group">
                    <label class="control-label visible-ie8 visible-ie9">Laste name</label>
                    <div class="input-icon">
                        <i class="fa fa-font"></i>
